...
function content_5d22cd9688bb69_82601534 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8" />
...
<td width="70%"><input type="text" name="email" size="50" value="<?php echo htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8', true);?>
" />
<?php if (isset($_smarty_tpl->tpl_vars['err_array']->value['email'])) {?><br /><span class="red"><?php echo $_smarty_tpl->tpl_vars['err_array']->value['email'];?>
</span><?php }?>
</td>
</tr>
</table>
